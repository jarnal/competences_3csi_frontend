...
function getFinalURL(id, suffixe){
    var url = Config.server_base_url + "evaluation_intervenant/";
    if(id)
        url = url + id;
    if(suffixe)
        url = url + "/" + suffixe;
...
/**
 * Returns all intervenant evaluations
 * @param callback
 */
...
/**
 * Returns a specific intervenant evaluation depending on his id
 * @param id
 * @param callback
 */
...
/**
 * Modifies an existing intervenant evaluation on the server
 * @param id
 * @param data
 * @param callback
 */
